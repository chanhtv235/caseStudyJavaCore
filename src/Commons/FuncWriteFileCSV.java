...
public class FuncWriteFileCSV {
    ...
    private static final String FILE_BOOKING_CUSTOMER ="src/Data/Booking.csv";

    public static void wirteVillaToCSVFile(ArrayList<Villa> listVilla){
    ...
    public static void wirteHouseToCSVFile(ArrayList<House> listHouse){
        FileWriter fileWriter=null;
        try {
    ...
    public static void wirteRoomToCSVFile(ArrayList<Room> listRoom){
        FileWriter fileWriter=null;
        try {
...
// "iD,customerName,birthdayOfCustomer,gender,customerId,customerPhone,customerEmail,customerType,customerAddress";
    ...
    public static void wirteBookingToCSVFile(ArrayList<Customer> listCustomer){
        FileWriter fileWriter=null;
        try {
